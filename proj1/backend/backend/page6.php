...
<body>
    ...
    <div>
        ...
        <div class="Row1">
            ...
            <p style="text-align: center; font-size: large; text-decoration: underline;">RESEARCH SUPERVISION : </p>
            <p style="text-align: left;">PhD Thesis Supervision </p>


            <div class="grid-container">
                <div class="grid-row">
                    <div class="grid-item">Serial. No.</div>
                    <div class="grid-item">	Name of the Student/Research Scholar</div>
                    <div class="grid-item">	Title of Thesis</div>
                    <div class="grid-item">Role</div>
                    <div class="grid-item">	Ongoing/Completed</div>
                    <div class="grid-item">	Ongoing since/Year of Completion</div>
        ...
        <div class="Row1">
            ...
            <p style="text-align: left;">M.Tech/M.E./Master's Degree </p>
        ...
        <div class="Row1">
            ...
            <p style="text-align: left;">B.Tech/B.E./Bachelor's Degree </p>
